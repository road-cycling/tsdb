...
#ifndef TIMESERIES_DB_BLOCKBUILDER_H
#define TIMESERIES_DB_BLOCKBUILDER_H
...
public:
    ...
    std::vector<std::bitset<64>> ReadBackBitstream() const;
...
#endif //TIMESERIES_DB_BLOCKBUILDER_H
